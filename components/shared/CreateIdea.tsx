            ...
            <div className={`space-y-5 rounded-2xl border border-white/10 ${isModal ? "bg-transparent" : "bg-white/5"} p-6 backdrop-blur-sm`}>
                ...
                <div className="flex flex-col gap-3 pt-2 sm:flex-row">
                    ...
                    <Button
                        ...
                        disabled={loading || imageUploading}
                        className="flex-1 rounded-xl bg-green-500 px-6 py-6 text-sm font-bold text-green-950 shadow-lg shadow-green-500/25 transition-all hover:bg-green-400 disabled:opacity-50 h-auto"
                    >
