...
export default function MembersManagement({ accessToken }: { accessToken: string }) {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-2xl font-black text-white">Members Management</h2>
                <p className="mt-1 text-sm text-green-200/50">View all users, edit roles and activate/deactivate accounts.</p>
            </div>
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-xs text-green-200/50">{member.email}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <div className="flex items-center justify-end gap-3">
                                            ...
                                            <select
                                                ...
                                                className="rounded-lg border border-white/10 bg-green-950/50 px-3 py-1.5 text-xs text-white outline-none focus:border-amber-400/50 focus:ring-1 focus:ring-amber-400/50"
                                            >
